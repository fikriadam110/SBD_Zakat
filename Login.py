...
class MainWindow:
    def __init__(self):
        ...
        self.frm_login = Frame(self.root, background='#42A079', borderwidth=0, relief=GROOVE, width=390,height=290)
        self.frm_login.place(x=45,y=330)

        self.lbl_login = Label(self.root, font=('Lucida Sans',28),bg="#42A079",fg="#FFFFFF",text="Login").place(x=191,y=340)
        ...
        self.btn_login = ttk.Button(self.root,style="Login.TButton", text="Login", width=8, command=lambda: [])
        self.btn_login.place(x=100,y=540)

        self.btn_login = ttk.Button(self.root,style="Login.TButton", text="Sign Up", width=8, command=lambda: [])
        self.btn_login.place(x=270,y=540)
